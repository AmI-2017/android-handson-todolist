 ...
 */
public class GetSingleTaskFromJson {

    public static Task readJsonStream(InputStream in) throws IOException {
    ...
    public static Task readTask(JsonReader reader) throws IOException {
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("task")  && reader.peek() != JsonToken.NULL) {

                task = readSingleTask(reader);
            } else {
                reader.skipValue();
            }
        }
